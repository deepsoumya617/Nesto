      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="z-10 w-full bg-white dark:bg-black">
          ...
          <div className="mb-2 flex items-center gap-3 px-5 py-3">
            <Button
              className="cursor-pointer rounded-none text-xs font-medium tracking-wide"
              size="sm"
              // onClick={resetEditor}
            ...
            <Button
              className="group cursor-pointer rounded-none px-3 text-xs font-medium tracking-wide shadow-none"
              size="sm"
